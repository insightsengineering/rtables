...
#' @param format (`string`, `function`, or `list`)\cr format associated with this split. Formats can be declared via strings (`"xx.x"`)
#'   or function. In cases such as `analyze` calls, they can be character vectors or lists of functions. See
#'   [formatters::list_valid_format_labels()] for a list of all available format strings.
