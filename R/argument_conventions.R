...
lyt_args <- function( lyt, var, vars, label, labels_var, varlabels, split_format,
                     ...
                     incl_all, indent_mod, show_labels, visible_label, var_labels, cvar) NULL
...
#' @rdname constr_args
constr_args <- function(kids, cont, lev, iscontent, cinfo, labelrow, vals, cspan, visible_label, cindent_mod, cvar, label, cextra_args) NULL
