...
#' @param avar (`character(1)`)\cr the variable to be analyzed. Defaults to the first variable in `data`.
...
#' @param .default_rlabel (`character(1)`)\cr this is an implementation detail that should not be set by end users.
#'
#' @details
