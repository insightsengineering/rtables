...
To understand how to use this package, please refer to the [Introduction to `rtables`](https://insightsengineering.github.io/rtables/latest-tag/articles/rtables.html) article, which provides multiple examples of code implementation.
