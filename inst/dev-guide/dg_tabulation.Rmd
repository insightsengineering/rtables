...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_dir = "../../docs/dev-guide")})
---
...
xxx to get multiple split vectors you need to break the nesting with `nest = FALSE` or by adding a `split_rows_by` after an `analyze` call.
