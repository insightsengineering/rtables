...
Note that all the data is created using random number generators. All `ex_*` data which is currently attached to the `rtables` package were created using [`random.cdisc.data`](https://insightsengineering.github.io/random.cdisc.data/) another R package that we intend to release as open source soon.
