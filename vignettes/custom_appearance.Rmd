...
With inset - 
Notice, the inset does not apply to any title materials (main title, subtitles, page titles), provenance footer materials and any horizontal dividers. Inset settings is applied to top-left materials, referential footnotes and main footer materials.
...
note that the levels associated with the variable "SEX" no longer appear. 
...
basic_table(
  ...
  split_cols_by("ARM") %>%
  split_rows_by("SEX", split_fun = drop_split_levels, label_pos = "hidden") %>%
