...
Now, to understand why only these two have this feature, lets see the structure of a table built with section dividers:

```{r}
lyt <- basic_table() %>%
    split_rows_by("ARM", section_div = "-") %>%
    split_rows_by("STRATA1", section_div = " ") %>%
    analyze("AGE", section_div = "+")
...
# [1] trailing_section_div,LabelRow-method trailing_section_div,TableRow-method
```
