...
This is a not-so-short not-comprehensive guide to debugging `rtables`. It is to be considered, though, of general validity and of personal use.

-=-=-=- Notes from meeting
Debugging:
-> easy to find the problem
-> never write clever code, impossible to debug
