...
spl="VarLevelSplit"
```
(xxx add getClass inheritance call, describe that we have specific method for multivarsplit but not allsplit -> only inherited from split)
