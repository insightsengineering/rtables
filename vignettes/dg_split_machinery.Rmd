...
basic_table() %>%
    ...
    build_table(DM) %>% 
    prune_table() # only to take out NAs in print
...
# --->  # Main constructor of SplitValue objects
...
example with simple split function + extra args (exploration too)
