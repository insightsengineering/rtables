...
basic_table() %>% 
    split_rows_by("ARM") %>% 
    split_rows_by("SEX", split_fun = drop_split_levels) %>% 
    analyze("BMRKR1", extra_args = list("a" = 3)) %>% 
    build_table(DM)
