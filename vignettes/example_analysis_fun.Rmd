...
## Helper Functions: Cox Regression Model Calculations

#### `tidy` Method for `summary.coxph` Objects
...
a_cox_summary <- function(df,
  ...
  cov_rows <- h_coxreg_extract_effect(effect = "ARM", covar = cov, mod = model, data = df)
