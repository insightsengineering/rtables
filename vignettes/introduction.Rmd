...
Once we have createad a table, we can inspect its structure using a
number of functions. 
...
`make_col_df()` similary accepts `visible_only`, though here the meaining is slightly different, indicating
