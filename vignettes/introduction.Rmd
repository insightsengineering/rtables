...
Becker](https://www.youtube.com/watch?v=CBQzZ8ZhXLA) and 
...
## Conceptual Model
- tables as a faceted data visualization
- ggplot2 example

## Overview
- graphic: layout --> formatted table
...
More comparisons of the various tabulation frameworks can be found in
a summary compiled by the 
[R Consortium Tables Working Group](https://github.com/RConsortium/rtrs-wg).
