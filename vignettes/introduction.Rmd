...
In clinical trials analyses the number of patients per column is often referred to as `N` (rather than the overall population which is commonly referred to as `N`). In `rtables` the column counts can be added using the `add_colcounts` function:
