...
We use the `trim_rows()` function and pass it our table and a criteria function. All rows where the criteria function returns `TRUE` will be removed, all others will be retained. 
...
Sort the ethnicity by observations, increasing
