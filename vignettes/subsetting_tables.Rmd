...
will appear. Please consider reading relevant vignette about [referential footnotes](https://roche.github.io/rtables/main/articles/title_footer.html#referential-footnotes).
...
tbl[1:3, 2:3, keep_titles = FALSE, keep_fnotes = TRUE]

# Referential footnotes are not influenced by `keep_fnotes = FALSE`
tbl[1:3, keep_titles = TRUE, keep_fnotes = FALSE]
```
