...
`NULL %>% split_cols_by("ARM") %>% split_cols_by("SEX", newtoplev = TRUE)`
...
layout = NULL %>% split_cols_by("ARM", "Arm") %>%
       ...
       summarise_row_groups_count(lbl = "Overall (N)") %>%
...
```
layout = NULL %>% split_cols_by("ARM", "Arm A", lbl = "Arm") %>%
       split_rows_by("RACE", "ethnicity") %>%
